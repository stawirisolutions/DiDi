...
import { Card, CardContent, CardMedia, Chip, IconButton, Stack, Rating, Typography, CardActionArea } from '@mui/material';
import { FavoriteBorder, PinDropOutlined } from '@mui/icons-material';
import Link from 'next/link';
import React from 'react';
  ...
  return (
    <Card variant='outlined'>
      <CardActionArea LinkComponent={Link} href='#'>
        ...
        >
          <Chip sx={{ color: 'white' }} label='20% OFF' variant='filled' size='small' color='secondary' />
          <IconButton color='secondary' sx={{ height: 'fit-content', backgroundColor: 'white' }} size='small'>
        ...
        <CardContent>
          <Stack gap={1}>
            <Typography noWrap variant='h6' color='textPrimary' fontWeight={600}>Service Name</Typography>
            <Stack direction='row' gap={1} alignItems='center'>
              <Rating size='small' readOnly value={4.5} precision={0.1} />
            ...
            <Typography color='textSecondary'>Store Name</Typography>
            <Stack direction='row' gap={1} alignItems='center'>
              <Typography variant='subtitle1' fontWeight={600} color='secondary'>Ksh 1,000 / month</Typography>
              <Typography variant='body2' sx={{ textDecoration: 'line-through' }} color='textSecondary'>Ksh 1,200</Typography>
            </Stack>
          </Stack>
        </CardContent>
      </CardActionArea>
