...
import RHFEditor from '@/app/components/hookform/RHFEditor';
import { RHFSelect } from '@/app/components/hookform/RHFSelect';
import RHFTextField from '@/app/components/hookform/RHFTextField';
import RHFUpload from '@/app/components/hookform/RHFUpload';
import useAxios from '@/app/hooks/useAxios';
import useMainStore from '@/app/store/main-store';
import { compressImageHandler, randomString } from '@/app/utils/data';
...
const ProductForm = ({ token, product, productId }: PRODUCT_FORM_PROPS) => {
